\section{Clase 4. Exposición de los problemas de la clase 3}
\textbf{18/02/2025}
...
\begin{figure}[h!]
    \begin{center}
        \begin{tabular}{cc}
            \includegraphics[scale=0.15]{clase4/problema3.1.jpeg}&\includegraphics[scale=0.15]{clase4/problema3.2.jpeg}
        \end{tabular}
    \end{center}
...
\begin{figure}[h!]
    ...
    \begin{center}
        \begin{tabular}{cccc}
            \includegraphics[scale=0.09]{clase4/problema4.1.jpeg}&\includegraphics[scale=0.09]{clase4/problema4.2.jpeg}&\includegraphics[scale=0.09]{clase4/problema4.3.jpeg}&\includegraphics[scale=0.09]{clase4/problema4.4.jpeg}
        \end{tabular}
    \end{center}
\end{figure}
