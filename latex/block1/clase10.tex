\section{Clase 10. Configuraciones geométricas}
\textbf{05/03/2025}
...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \end{center}
    \begin{center}
        \input{../graficosTikz/b1Tikz/tikzC10/fig1.tex}
    \end{center}
\end{minipage}
\par
...
\begin{minipage}[t]{0.48\textwidth}
    \noindent
    \begin{center}
        \input{../graficosTikz/b1Tikz/tikzC10/fig2.tex}
    \end{center}
...
\begin{minipage}[t]{0.48\textwidth}
    \noindent
    \begin{center}
        \input{../graficosTikz/b1Tikz/tikzC10/fig3.tex}
    \end{center}
\end{minipage}
