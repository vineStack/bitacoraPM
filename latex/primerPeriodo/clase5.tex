...
\begin{center}
    \includegraphics[scale=0.1]{clases/images/clase5/semiTrapecio.jpeg}
\end{center}

Despues se doblan las puntas, de modo que quede el prisma de la siguiente forma.

\begin{center}
    \includegraphics[scale=0.09]{clases/images/clase5/trapecioFin.jpeg}
\end{center}

Y se hace uno similar para un cuarto del tamaño de la hoja
\begin{figure}[ht!]
    \begin{center}
        \includegraphics[scale=0.09]{clases/images/clase5/prismaPyG.jpeg}
    \end{center}
\end{figure}
